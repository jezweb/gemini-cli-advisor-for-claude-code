...
main() {
    ...
    echo "  ${GREEN}RECOMMENDED:${NC} Use API Key (no browser popups!)"
    echo "  1. Get free key: https://aistudio.google.com/apikey"
    echo "  2. Run: export GOOGLE_API_KEY=\"your-key-here\""
    echo "  ${YELLOW}Alternative:${NC} OAuth with: gemini auth (may require re-auth)"
    echo ""
    ...
    echo "   ${BLUE}Recommended - API Key:${NC}"
